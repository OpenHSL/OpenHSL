...
################################################################################
## Form generated from reading UI file 'datmant_2jgvaPn.ui'
##
...
class Ui_DATMantMainWindow(object):
    def setupUi(self, DATMantMainWindow):
        ...
        DATMantMainWindow.resize(854, 758)
        ...
        self.lstDefectsAndColors.setFont(font1)
        ...
        self.txtBrushDiameter.setMaximumSize(QSize(100, 16777215))
        self.txtBrushDiameter.setFont(font1)
        ...
        self.txtImageDir.setFont(font1)
        ...
        self.txt_HSI_slider.setMaximumSize(QSize(100, 16777215))
        ...
        self.txtImageHasDefectMask.setFont(font1)
        ...
        self.txtImageStatus.setFont(font1)
    ...
    def retranslateUi(self, DATMantMainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("DATMantMainWindow", u"Annotated defect:", None))
        self.label_2.setText(QCoreApplication.translate("DATMantMainWindow", u"Brush diameter:", None))
        self.label_7.setText(QCoreApplication.translate("DATMantMainWindow", u"Image folder:", None))
        self.btnBrowseImageDir.setText(QCoreApplication.translate("DATMantMainWindow", u"Browse...", None))
        self.label_15.setText(QCoreApplication.translate("DATMantMainWindow", u"Current image:", None))
        ...
        self.label_3.setText(QCoreApplication.translate("DATMantMainWindow", u"Defect .shp folder:", None))
