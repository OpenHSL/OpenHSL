...
1) CLI версией [ссылка](https://github.com/OpenHSL/OpenHSL/blob/main/cli_demo_builder.py), выполнив команду *python cli_demo_builder.py*
...
1) CLI версией [ссылка](https://github.com/OpenHSL/OpenHSL/blob/main/cli_demo_painter.py), поддерживающей только методы автоматизированной разметки, выполнив команду *python cli_demo_painter.py*
...
1) CLI версией [ссылка](https://github.com/OpenHSL/OpenHSL/blob/main/cli_demo_trainer.py), выполнив команду python *cli_demo_trainer.py*
