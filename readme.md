...
1) CLI версией, выполнив команду *python cli_demo_builder.py*
...
1) CLI версией, поддерживающей только методы автоматизированной разметки, выполнив команду *python cli_demo_painter.py*
...
1) CLI версией, выполнив команду python *cli_demo_trainer.py*
